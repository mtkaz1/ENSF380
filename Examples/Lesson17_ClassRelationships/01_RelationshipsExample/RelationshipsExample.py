...
def main():
    ...
    new_house.build_deck("wood", 37.5, "2025")
    new_house.renovate_bathroom("farmhouse", new_tub)
    new_house.update_roof("asphalt", "2025")
    ...
    contract = RentalAgreement("January 2025", "June 2025", 2500.00, [renter1, renter2], new_house)
