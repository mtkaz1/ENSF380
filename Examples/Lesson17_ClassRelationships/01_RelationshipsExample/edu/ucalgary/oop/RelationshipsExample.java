...
public class RelationshipsExample{
    ...
    //Make renovations.
    newBuild.buildDeck("wood", 37.5, "2025");
    newBuild.renovateBathroom("farmhouse", newTub);
    newBuild.updateRoof("asphalt", "2025");
    ...
    RentalAgreement contract = new RentalAgreement("January 2025", "June 2025", 2500.00, renterInfo, newBuild);
